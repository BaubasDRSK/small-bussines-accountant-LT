        ...
        <div className="max-w-7xl mx-auto mt-3 py-4 sm:px-6 lg:px-8 flex flex-wrap justify-items-center bg-white dark:bg-gray-800"> 
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" className="px-6 py-3 cursor-pointer" onClick={()=>doSort('invoice_number')}>
                        ...
                        <th scope="col" className="px-6 py-3 cursor-pointer" onClick={()=>doSort('total')}>
                            Total
                        </th>
                        <th scope="col" className="px-6 py-3 cursor-pointer" onClick={()=>doSort('paid')}>
                            Paid
                        </th>
                        <th scope="col" className="px-6 py-3 cursor-pointer"onClick={()=>doSort('due')}>
                            Due
                        </th>
                    </tr>
                </thead>
